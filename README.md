...
- Collision-aware temporal context adapts with zoom: sub-day views keep day + month + year ambient while ticks carry time; day-scale views keep month + year ambient while ticks carry day numbers; month-scale views keep the year ambient while month names move onto the axis; year-scale views rely on the normal year ticks. Sparse context labels collapse hierarchically when space is constrained instead of losing temporal context.
