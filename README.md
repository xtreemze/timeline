...
These five loops are generated by the same real-browser Playwright flow used in CI, so the README demonstrates the application that the browser tests actually exercised.

### Navigate the continuum

Zoom and pan the retained chronology while the relation graph stays synchronized.

<img src="https://xtreemze.github.io/timeline/showcase/01-timeline-navigation.gif" alt="Lūm timeline zoom and pan with synchronized relation graph" width="760">

### Read an occurrence in context

Focused detail occupies the sidebar without hiding the graph or chronology.

<img src="https://xtreemze.github.io/timeline/showcase/02-focused-context.gif" alt="Lūm focused occurrence context with graph and chronology retained" width="760">

### Inspect evidence

Switch from contextual reading to the dedicated evidence dossier and back.

<img src="https://xtreemze.github.io/timeline/showcase/03-evidence.gif" alt="Lūm focused occurrence evidence dossier" width="760">

### Explore the relation graph

Pan, zoom, and recenter the graph independently while timeline state remains intact.

<img src="https://xtreemze.github.io/timeline/showcase/04-relation-graph.gif" alt="Lūm interactive temporal relation graph" width="760">

### Use the full product on mobile

Portrait composition keeps project actions, browsing, chronology, and graph reachable.

<img src="https://xtreemze.github.io/timeline/showcase/05-mobile.gif" alt="Lūm mobile portrait application composition" width="320">
