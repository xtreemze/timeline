...
const STORY_SPECS =
  ...
  [
  {
    ...
    scenes: [
      ...
      ["red-attack", ["1012-03-13T13:00Z", "1012-03-15T13:45Z"], "Wolf attacks Little Red Riding Hood", "Wolf abandons the deception and attacks Little Red Riding Hood inside the cottage, escalating the story from manipulation to immediate physical danger.", "conflict", "danger", "hero-split", "red-cottage-bedroom-place", "red-wolf", "red-riding-hood", "attacks"],
  ...
  },
  {
    ...
    scenes: [
      ...
      ["jack-observes-giant", ["1043-05-11T11:00Z", "1043-05-13T11:45Z"], "Jack watches Castle Giant", "Jack watches Castle Giant in the castle hall and learns the rhythm of the household before acting, giving the later theft a clear observational step rather than treating it as instantaneous.", "discovery", "search", "evidence-dossier", "jack-sky-hall-place", "jack", "jack-giant", "watches"],
  ...
  },
  {
    ...
    scenes: [
      ...
      ["rapunzel-prince-visits", ["1061-06-11T12:00Z", "1061-06-16T13:30Z"], "Tower Prince visits Rapunzel", "Tower Prince visits Rapunzel inside the chamber after learning the tower's access pattern, converting distant observation into a direct relationship hidden from the controlling household.", "relationship", "crown", "evidence-dossier", "rapunzel-tower-chamber-place", "rapunzel-prince", "rapunzel", "visits"],
  ...
  },
  {
    ...
    scenes: [
      ...
      ["frog-follows", ["1078-09-16T13:00Z", "1078-09-18T13:45Z"], "Frog Prince follows Princess", "Frog Prince follows Princess from the garden toward the palace instead of accepting the broken promise, moving the unresolved relationship into the household where others can witness it.", "movement", "place", "hero-split", "frog-castle-gate-place", "frog-prince", "frog-princess", "follows"],
  ...
  },
  {
    ...
    scenes: [
      ...
      ["rumpel-first-help", ["1096-02-06T22:00Z", "1096-02-07T06:00Z"], "Rumpelstiltskin helps Miller's Daughter", "Rumpelstiltskin helps Miller's Daughter during the first night of confinement and demonstrates a solution that appears miraculous while introducing a new dependency.", "relationship", "magic", "evidence-dossier", "rumpel-spinning-room-place", "rumpel-helper", "rumpel-daughter", "helps"],
...
function makeItem(story, scene, sequence) {
  ...
  const [start, end] = Array.isArray(timeSpec) ? timeSpec : [timeSpec, null];
  return {
    id,
    kind: end ? "range" : "event",
    start,
    end,
    time: end ? temporalInterval(start, end) : temporalInstant(start),
    title,
    description,
    categoryId,
