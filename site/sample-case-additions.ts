...
const STORY_SPECS = [
  ...
  },
  {
    ...
    scenes: [
      ...
      ["hg-hansel-captive", "1027-09-12T12:30Z", "Witch imprisons Hansel", "Witch imprisons Hansel inside the house and begins controlling the siblings separately, making the threat concrete and giving Gretel a reason to look for an opening to act.", "conflict", "danger", "evidence-dossier", "hg-sugar-house-place", "hg-witch", "hg-hansel", "imprisons"],
  ...
  },
  {
    ...
    scenes: [
      ...
      ["jack-sheltered", "1043-05-09T10:00Z", "Giant's Wife shelters Jack", "Giant's Wife shelters Jack inside the sky castle and warns him about the danger nearby, creating a temporary alliance within a place otherwise controlled by the Giant.", "relationship", "home", "editorial-mosaic", "jack-sky-hall-place", "jack-giants-wife", "jack", "shelters"],
      ["jack-observes-giant", "1043-05-11T11:00Z", "Jack watches Giant", "Jack watches Giant in the castle hall and learns the rhythm of the household before acting, giving the later theft a clear observational step rather than treating it as instantaneous.", "discovery", "search", "evidence-dossier", "jack-sky-hall-place", "jack", "jack-giant", "watches"],
      ["jack-first-theft", "1043-05-13T12:00Z", "Jack steals from Giant", "Jack steals from Giant after the household settles, beginning the material escalation and creating the conflict that will eventually turn the return route into a pursuit.", "conflict", "object", "hero-split", "jack-sky-hall-place", "jack", "jack-giant", "stealsFrom"],
      ...
      ["jack-pursuit", "1043-05-18T14:00Z", "Giant chases Jack", "Giant chases Jack across the sky-castle yard toward the beanstalk, turning the vertical connection into an escape route and linking the remote cluster back to the farm below.", "conflict", "danger", "evidence-dossier", "jack-sky-yard-place", "jack-giant", "jack", "chases"],
