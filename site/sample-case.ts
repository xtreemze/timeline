...
const SAMPLE = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Red Riding Hood lives with Mother at the edge of the forest and learns the household routines that frame the later errand. This interval establishes their durable relationship before the concentrated journey begins.",
      categoryId: "context",
    ...
    },
    {
      ...
      description:
        "Mother prepares a Basket and entrusts it to Red Riding Hood for the household visit. The handoff establishes the purpose of the journey and the object carried through the forest.",
      categoryId: "decision",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "Red Riding Hood begins the forest journey while carrying the Basket. The route separates the safety of home from the later encounters and gives the movement a reusable spatial context.",
      categoryId: "movement",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "Red Riding Hood meets the Wolf on the forest path and speaks with him without recognizing the danger. Their encounter gives the Wolf information he can exploit during the rest of the journey.",
      categoryId: "conflict",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
      ...
      relationChanges: [{ relationshipId: "rel-red-wolf-threat", operation: "activate" }],
    },
    {
      id: "red-flower-delay",
      kind: "event",
      ...
      description:
        "The Wolf persuades Red Riding Hood to linger in the flower meadow rather than continue directly along the route. The delay creates the temporal opening that lets him reach the cottage first.",
      categoryId: "decision",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "The Wolf reaches Grandmother at her cottage before the visitor arrives and attacks her, turning the destination into the central danger point of the narrative.",
      categoryId: "conflict",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "The Wolf impersonates Grandmother inside the cottage so that the arriving child will misread the situation. The disguise changes the apparent identity of the person waiting in the bed.",
      categoryId: "state-change",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "Red Riding Hood encounters the Wolf in the cottage and notices that the figure in bed does not match what she expects. The familiar exchange escalates the deception into immediate danger.",
      categoryId: "discovery",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "The Woodcutter confronts the Wolf at the cottage and interrupts the attack. His intervention breaks the predator's control of the scene and permits the household to recover.",
      categoryId: "conflict",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
    ...
    },
    {
      ...
      description:
        "Grandmother welcomes Red Riding Hood after the danger has passed, closing the errand with both characters safe at the cottage and making the consequences of the forest encounter explicit.",
      categoryId: "resolution",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-red-cap"],
      ...
      relationChanges: [{ relationshipId: "rel-red-wolf-threat", operation: "deactivate" }],
    },
    {
      ...
      description:
        "Hansel remains with Father during a prolonged period of household scarcity that establishes the pressure behind the later abandonment plan. The interval separates background hardship from the concentrated forest action.",
      categoryId: "context",
      presentation: { variant: "hero-split" },
    ...
    },
    {
      ...
      description:
        "Stepmother pressures Father to abandon the children in the forest because the household cannot support them. The decision creates the causal link between scarcity and the dangerous journey.",
      categoryId: "decision",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "Hansel carries Breadcrumbs into the forest intending to leave a trail that can guide him home. The fragile navigation strategy becomes a physical object whose later disappearance changes the journey.",
      categoryId: "decision",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "Father leaves Hansel at the forest trail after leading the children away from the family cottage. The departure turns the planned journey into abandonment and removes the adult guide.",
      categoryId: "movement",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "Hansel searches for the Breadcrumbs at the clearing but discovers that the trail can no longer guide him home. The failed navigation method forces the children deeper into the forest.",
      categoryId: "discovery",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "Gretel discovers the Gingerbread House after the children wander through the forest. The attractive dwelling becomes both a destination and the spatial anchor for the story's central danger.",
      categoryId: "discovery",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "The Witch traps Hansel at the Gingerbread House and takes control of the children after presenting the dwelling as a place of food and safety. The deception becomes explicit captivity.",
      categoryId: "conflict",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
      ...
      relationChanges: [{ relationshipId: "rel-hg-witch-threat", operation: "activate" }],
    },
    {
      ...
      description:
        "Gretel deceives the Witch near the oven by pretending not to understand the command she has been given. The tactic reverses the power of the scene and creates a chance to escape.",
      categoryId: "decision",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
    ...
    },
    {
      ...
      description:
        "Gretel pushes the Witch into the oven when the opportunity opens, ending the captivity at the Gingerbread House. The decisive act resolves the immediate threat and frees the children.",
      categoryId: "state-change",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
      ...
      relationChanges: [{ relationshipId: "rel-hg-witch-threat", operation: "deactivate" }],
    },
    {
      id: "hg-return-home",
      kind: "event",
      ...
      description:
        "Father welcomes Hansel and Gretel when they return to the family cottage, closing the forest journey and restoring the household after the danger and separation have ended.",
      categoryId: "resolution",
      presentation: { variant: "hero-split" },
      evidenceIds: ["src-hansel-gretel"],
  ...
  stories: [
    ...
    },
    {
      ...
      description:
        "A child carries a household errand through the forest, encounters a predatory wolf, is diverted from the direct route, reaches Grandmother's cottage after the wolf, recognizes the deception, and survives through intervention and reunion.",
      itemIds: [
        "red-upbringing",
        "red-basket-prepared",
        "red-forest-departure",
        "red-meets-wolf",
        "red-flower-delay",
        "red-grandmother-attack",
        "red-disguise",
        "red-cottage-encounter",
        "red-woodcutter-intervenes",
        "red-safe",
      ],
      extensions: {
        narrative: {
    ...
    },
    {
      ...
      description:
        "Household scarcity leads to abandonment in the forest. Hansel's breadcrumb strategy fails, the children discover the Gingerbread House, the Witch captures Hansel, Gretel reverses the trap, and the siblings return to Father.",
      itemIds: [
        "hg-family-hardship",
        "hg-stepmother-plan",
        "hg-carries-breadcrumbs",
        "hg-abandoned",
        "hg-trail-fails",
        "hg-discovers-gingerbread-house",
        "hg-witch-captures",
        "hg-gretel-deceives",
        "hg-witch-defeated",
        "hg-return-home",
  ...
  relationships: [
    ...
    {
      id: "rel-red-wolf-targets-riding-hood",
      subjectId: "red-wolf",
      objectId: "red-riding-hood",
      predicate: "targets",
      sourceIds: ["src-red-cap"],
    ...
    {
      id: "rel-hg-father-supports-gretel",
      subjectId: "hg-father",
      objectId: "hg-gretel",
      predicate: "supports",
      sourceIds: ["src-hansel-gretel"],
