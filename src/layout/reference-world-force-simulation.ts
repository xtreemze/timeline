...
export class ReferenceWorldForceSimulation implements WorldForceSimulationBackend {
  ...
  #rebuildClusterSimulations(): void {
    ...
    for (const [group, nodes] of grouped) {
      ...
      // Relationships retire before D3 owns a cluster. Keeping this null in
      // both directions ensures gather/scatter is caused only by D3
      // charge/collision/anchor forces; ordinary links return after expansion.
