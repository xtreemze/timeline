...
Stories, entities, and temporal relationships are retained in the `_timeline` envelope when the target structure does not have an equivalent first-class concept.
