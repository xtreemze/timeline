...
- The global Edit/Browse/View dock is one persistent bottom footer app bar at every ordinary viewport size; timeline orientation never moves or splits those application actions. Expanded View controls may recompose around their invoker, but must remain clamped to the visual viewport.
