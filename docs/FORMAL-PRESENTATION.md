...
- source-dimension, verified 60 fps animated WebP for motion scenes, emitted only after the raw browser-presented capture sustains at least 59 actual decoded frames per second.
