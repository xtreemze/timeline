...
- source-dimension, 60 fps animated WebP for motion scenes, produced only after CI verifies at least 59 actual Chromium-presented frames per second before encoding.
