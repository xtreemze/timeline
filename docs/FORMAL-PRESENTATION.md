...
- source-dimension, verified 60 fps animated WebP for motion scenes, emitted only after Chromium current-tab source-frame evidence and the decoded raw VP8 WebM each sustain at least 59 actual fps with 95% recording-window coverage and the independent browser frame clock also sustains at least 59 fps.
