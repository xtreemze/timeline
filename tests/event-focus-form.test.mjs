...
test("fullscreen preserves the left workspace tool dock inside the fullscreen subtree", async () => {
  ...
  assert.match(app, /orientation === "portrait"[\s\S]*triggerRect\.left - dockWidth - gap[\s\S]*triggerRect\.top \+ \(triggerRect\.height - dockHeight\) \/ 2[\s\S]*triggerRect\.left \+ \(triggerRect\.width - dockWidth\) \/ 2[\s\S]*preferredTop = triggerRect\.bottom \+ gap/);
