...
test("touch graph uses forgiving node and edge hit targets with a visible long-press state", async () => {
  ...
  assert.match(
    styles,
    /data-touch-drag="holding"\]::after\s*\{[\s\S]*opacity:\s*0\.95[\s\S]*transform:\s*scale\(0\.78\)/,
  );
